...
export default function TaskCompleteScreen() {
  ...
  const { id, submission_id } = useLocalSearchParams<{
    id: string;
  ...
  const submitMutation = useMutation({
    ...
    onError: (error: any) => {
      Alert.alert(
        t("common.error"),
        error.message || t("task_complete.errors.submit_failed"),
      );
    },
  });
  ...
  const pickImage = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        t("task_complete.errors.permission_required"),
        t("task_complete.errors.gallery_permission"),
      );
      return;
    }
  ...
  const takePhoto = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        t("task_complete.errors.permission_required"),
        t("task_complete.errors.camera_permission"),
      );
      return;
    }
  ...
  return (
    ...
    >
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>{t("task_complete.info_text")}</Text>
      </View>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          ...
          {t("task_complete.screenshot_title")}
        </Text>
          ...
          <View style={styles.imagePreview}>
            <View style={styles.imageUploadedBox}>
              ...
              <Text style={styles.imageUploadedText}>
                {t("task_complete.screenshot_uploaded")}
              </Text>
            </View>
            <TouchableOpacity
          ...
          <View style={styles.uploadButtons}>
            <TouchableOpacity style={styles.uploadButton} onPress={pickImage}>
              ...
              <Text style={styles.uploadButtonText}>
                {t("task_complete.choose_gallery")}
              </Text>
            </TouchableOpacity>
