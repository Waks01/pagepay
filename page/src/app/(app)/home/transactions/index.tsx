...
export default function TransactionHistoryScreen() {
  ...
  const openDetail = useCallback(
    (tx: TxItem) => {
      ...
      router.push({
        pathname: "/(app)/home/transactions/[id]",
        params: {
          id: tx.txId || tx.id,
          kind,
  ...
  const renderItem = useCallback(
    ({ item, index }: { item: TxItem; index: number }) => {
          ...
          <TouchableOpacity
            ...
            style={[
              styles.txCard,
              {
                ...
                borderColor: borderC,
                borderLeftColor: meta.accentHex,
                borderLeftWidth: 3,
              },
            ]}
          >
  ...
  const renderSectionHeader = useCallback(
    ({ section }: { section: { title: string } }) => {
      ...
      return (
        <TouchableOpacity
          onPress={() => {
            setDateFilter(isActive ? "all" : section.title);
            resetPage();
          }}
          activeOpacity={0.7}
