...
export default function SponsorTaskDetailScreen() {
  ...
  const approveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      Alert.alert(
        t("sponsor_task_detail.approved_title"),
        t("sponsor_task_detail.approved_message"),
      );
    },
    onError: (error: any) => {
  ...
  const rejectMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      setRejectionReason("");
      Alert.alert(
        t("sponsor_task_detail.rejected_title"),
        t("sponsor_task_detail.rejected_message"),
      );
    },
    onError: (error: any) => {
      Alert.alert(t("common.error"), error.message);
  ...
  const handleApprove = (submissionId: number) => {
    Alert.alert(
      ...
      [
        ...
        {
          text: t("sponsor_task_detail.approve_button"),
          onPress: () => approveMutation.mutate(submissionId),
        },
      ],
    );
  };
        ...
        <View style={styles.submissionHeader}>
          ...
          >
            <Text style={styles.statusText}>
              {t(`sponsor_task_detail.status.${item.status}`)}
            </Text>
          </View>
        </View>
        ...
        {item.ai_confidence !== null && (
          <View style={styles.aiScore}>
            ...
            <Text style={styles.aiScoreText}>
              {t("sponsor_task_detail.ai_confidence", {
        ...
        {item.proof_image_url && (
          <View style={styles.proofItem}>
            ...
            <Text style={styles.proofText}>
              {t("sponsor_task_detail.screenshot_provided")}
            </Text>
          </View>
        )}
              ...
              <View style={styles.actionsRow}>
                ...
                >
                  ...
                  <Text style={styles.approveButtonText}>
                    {t("sponsor_task_detail.approve_button")}
                  </Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={styles.rejectButtonText}>
                    {t("sponsor_task_detail.reject_button")}
                  </Text>
                </TouchableOpacity>
              </View>
            ) : (
                  ...
                  >
                    {rejectMutation.isPending ? (
                      ...
                      <Text style={styles.confirmRejectText}>
                        {t("sponsor_task_detail.confirm_reject")}
                      </Text>
                    )}
                  </TouchableOpacity>
                </View>
        ...
        {item.rejection_reason && (
          <View style={styles.rejectionBox}>
            <Text style={styles.rejectionLabel}>
              {t("sponsor_task_detail.rejection_reason_title")}
            </Text>
        ...
        ListEmptyComponent={
          <View style={styles.emptyContainer}>
            ...
            <Text style={styles.emptyText}>
              {t("sponsor_task_detail.no_submissions")}
            </Text>
          </View>
        }
      />
