...
export default function SponsorKYCScreen() {
  ...
  const [idType, setIdType] = useState<
    "nin" | "bvn" | "voters_card" | "drivers_license" | "passport"
  >("nin");
  ...
  const pickIDDocument = async () => {
    ...
    if (status !== "granted") {
      Alert.alert(
        t("sponsor_kyc.errors.permission_required"),
        t("sponsor_kyc.errors.permission_message"),
      );
      return;
    }
  ...
  return (
    ...
    >
      ...
      <View style={styles.infoCard}>
        ...
        <Text style={styles.infoText}>{t("sponsor_kyc.why_kyc_text")}</Text>
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          {t("sponsor_kyc.id_verification_title")}
        </Text>
          ...
          <View style={styles.idTypesGrid}>
            {ID_TYPES.map((type) => (
              <TouchableOpacity
                ...
                style={[
                  styles.idTypeOption,
                  idType === type.value && styles.idTypeOptionActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.idTypeText,
                    idType === type.value && styles.idTypeTextActive,
                  ]}
                >
                  {t(type.label)}
                </Text>
            ...
            {idDocument ? (
              <>
                ...
                <Text style={styles.uploadedText}>
                  {t("sponsor_kyc.document_uploaded")}
                </Text>
              </>
            ) : (
              <>
      ...
      <View style={styles.section}>
        <Text style={styles.sectionTitle}>
          {t("sponsor_kyc.business_info_title")}
        </Text>

        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("sponsor_kyc.business_reg_label")}
          </Text>
          <TextInput
            style={styles.input}
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>
            {t("sponsor_kyc.business_doc_label")}
          </Text>
          <TouchableOpacity
            style={styles.uploadButton}
      ...
      <TouchableOpacity
        style={[
          styles.submitButton,
          kycMutation.isPending && styles.submitButtonDisabled,
        ]}
